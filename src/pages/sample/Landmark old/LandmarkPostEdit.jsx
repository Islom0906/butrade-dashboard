...
const LandmarkPostEdit = () => {
    ...
    } = useQuery(["edit-landmark", editId], () => apiService.getDataByID("/about/landmarkcategories", editId), {
        enabled: false
    });
    ...
    const onFinish = (values) => {
        ...
        console.log(data)
        if (editLandmarkSuccess) {
            putLandmark({url: "/about/landmarkcategories", data, id: editId});
        } else {
            postLandmarkMutate({url: "/about/landmarkcategories/", data});
        }
    }
